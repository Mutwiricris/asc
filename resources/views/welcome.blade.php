                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 d-flex align-items-center">
                            <div class="caption">
                                <h1>Here we do more than  <span class="sub-color">Building</span></h1>
                                ...
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div class="text">
                                            <p>Ascend is a global branding and digital solutions center focus on
                        ...
                        <div class="col-lg-6">
                            <div class="imgs">
                                <div class="cube">
                                    <img src="{{asset("imgs/header/cube.svg")}}" alt="">
                                </div>
                                <div class="circle">
                                    <img src="{{asset("imgs/header/circle-badge.svg")}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="sec-head mb-100">
                        <div class="row">
                            ...
                            <div class="col-lg-7"><h4> At the heart of innovation, we co-create bold software, websites, apps, and SEO solutions — partnering with you from idea to ScaleUp.
                                    <span class="sub-color inline">We don’t just build tech, we build ventures.</span> </h4>
                                <a href="../inner_pages/services.html" class="butn butn-md butn-bord butn-rounded mt-40">
                                    <div class="d-flex align-items-center">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="item md-mb50">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ml-auto">
                                            <div class="icon invert">
                                                <img src="{{asset("common/imgs/icons/bezier-curve-solid.svg")}}"
                                                     alt="">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="img">
                                    <img src="{{asset("imgs/services/1.png")}}" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="item md-mb50">
                                <div class="cont">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ml-auto">
                                            <div class="icon invert">
                                                <img src="{{asset("common/imgs/icons/code-solid.svg")}}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="text">
                                ...
                                <div class="img">
                                    <img src="{{asset("imgs/services/2.png")}}" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="item">
                                <div class="cont">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="ml-auto">
                                            <div class="icon invert">
                                                <img src="{{asset("common/imgs/icons/chart-line-solid.svg")}}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="text">
                                ...
                                <div class="img">
                                    <img src="{{asset("imgs/services/3.png")}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="sec-head mb-100">
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                ...
                                <div class="gl-rate d-flex align-items-center mt-60">
                                    <div class="icon">
            ...
            <section class="blog-sa">
                <div class="container section-padding bord-thin-top-light">
                    <div class="sec-head mb-100">
                        <div class="row">
                            <div class="col-lg-5">
                                <h6 class="sub-head">Latest Articles</h6>
                            </div>
                            <div class="col-lg-7">
                                <h4>The place that we share everything related to
                                    <span class="sub-color inline">design trends, tips and more.</span>
                                </h4>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="info">
                                    <div class="sec-head">
                                        <h4>Success is a team play, right? <span class="sub-color inline">Let’s work
                                                    together!</span></h4>
                                    </div>
                                    <div class="mt-50 md-mb80">
                                        <h6>+068 5681 96 96</h6>
                                        <span class="d-block sub-color fz-14 mt-10">Call us for urgent</span>
                                        ...
                                        <div class="controls row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group mb-30">
                                                    <label for="form_name">Full Name <span
